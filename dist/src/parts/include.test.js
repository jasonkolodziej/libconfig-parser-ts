...
module.exports = new TestParser("Include", new Assertion(include(getFromFile("includeConfig.cfg", dir), dir, getFromFile), getFromFile("expected.conf", dir), "basic include example"), new Assertion((_ => {
    try {
